...
QT_MOC_LITERAL(3, 23, 8) // "position"
    ...
    "GameBoard\0cellClicked\0\0position"
};
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->cellClicked((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GameBoard::*)(const QPoint & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameBoard::cellClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameBoard::cellClicked(const QPoint & _t1)
{
